...
from experiment_HOLE_perfect_information import perfect_information_EI_UU_HOLE_function_caller_test
from experiment_HOLE_BayesInference_Tche import HOLE_function_Tche_caller_test
from experiment_HOLE_point_estimation_Tche import point_estimation_HOLE_function_Tche_caller_test
from experiment_HOLE_HVI_Bayes_Tche import Bayes_HVI_HOLE_function_Tche_caller_test
...
def run(args):
    ...
    functions = [perfect_information_EI_UU_HOLE_function_caller_test,
                 HOLE_function_Tche_caller_test,
                 point_estimation_HOLE_function_Tche_caller_test,
                 Bayes_HVI_HOLE_function_Tche_caller_test]
