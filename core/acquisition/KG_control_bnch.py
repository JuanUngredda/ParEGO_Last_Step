...
import os
import argparse
# from HVI_DEB_experiment import DEB_function_caller_test
from HVI_POL_experiment import POL_function_caller_test
from HVI_TNK_experiment import TNK_function_caller_test

#from HVI_SRN_experiment import SRN_function_caller_test
...
def run(args):
    ...
    funcions = [POL_function_caller_test, TNK_function_caller_test]
