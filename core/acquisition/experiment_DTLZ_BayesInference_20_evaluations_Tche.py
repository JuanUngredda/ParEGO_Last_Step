...
def HOLE_function_Lin_caller_test(rep):
    ...
    for num_queries_idx in range(len(max_number_DMqueries)):
        ...
        for first_query_iteration_element in first_query_iteration[num_queries_idx]:
            ...
            folder = "RESULTS"
            subfolder = "DTLZ2_Bayes_Assum_Tche_U_Tche_20_evals_n_queries_" + str(max_number_DMqueries[num_queries_idx])+"_first_iteration_"+str(first_query_iteration_element)
            cwd = os.getcwd()
