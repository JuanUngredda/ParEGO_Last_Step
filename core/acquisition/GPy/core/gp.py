...
class GP(Model):
    ...
    def posterior_variance_gradient(self, X, kern=None):
        """
        Compute the derivatives of the posterior variance with respect to X.
    ...
    def posterior_variance_gradient_var(self,X):
        """
        Computes variance of gradient of f
        """
