...
def Injector_function_Lin_caller_test(rep):
    ...
    for num_queries_idx in range(len(max_number_DMqueries)):
        ...
        for first_query_iteration_element in first_query_iteration[num_queries_idx]:
            ...
            folder = "RESULTS"
            subfolder = "RocketInjector_Bayes_Assum_Tche_U_Tche_200_evals_n_queries_" + str(max_number_DMqueries[num_queries_idx])+"_first_iteration_"+str(first_query_iteration_element)
            cwd = os.getcwd()
            ...
            first_query_position = int(np.floor((first_query_iteration_element/100)*200))
            # print("Finished Initialization")
            print(first_query_position)

            X, Y, Opportunity_cost = bo.run_optimization(max_iter =200,
                                                            rep=rep,
                                                            path=path,
                                                            verbosity=False,
...
# Injector_function_Lin_caller_test(rep=1)
