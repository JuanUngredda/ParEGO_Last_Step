...
def Bayes_HVI_HOLE_sampled_function_caller_test(rep):
    ...
    for num_queries_idx in range(len(max_number_DMqueries)):
        ...
        for first_query_iteration_element in first_query_iteration[num_queries_idx]:
            ...
            folder = "RESULTS"
            subfolder = "HOLE_HVI_Bayes_samples_as_target_" + str(max_number_DMqueries[num_queries_idx])+"_first_iteration_"+str(first_query_iteration_element)
            cwd = os.getcwd()
