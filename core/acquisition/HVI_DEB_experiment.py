...
def DEB_function_caller_test(rep):
    ...
    space =  GPyOpt.Design_space(space =[{'name': 'var_1', 'type': 'continuous', 'domain': (0.1 , 1)},{'name': 'var_2', 'type': 'continuous', 'domain': (0 , 5)}])#GPyOpt.Design_space(space =[{'name': 'var_1', 'type': 'continuous', 'domain': (0,100)}])#
    n_f = 2
    n_c = 2
    input_d = 2
    m =n_f
